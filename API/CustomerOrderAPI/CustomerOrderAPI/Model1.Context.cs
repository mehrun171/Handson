...
namespace CustomerOrderAPI
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Customer> GetCustomersByCountryFun(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("Country", country) :
                new ObjectParameter("Country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Customer>("GetCustomersByCountryFun", countryParameter);
        }
    
        public virtual ObjectResult<Customer> GetCustomersByCountryFun(string country, MergeOption mergeOption)
        {
            var countryParameter = country != null ?
                new ObjectParameter("Country", country) :
                new ObjectParameter("Country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Customer>("GetCustomersByCountryFun", mergeOption, countryParameter);
        }
    }
}
