...
namespace Custom_Validations_Prj.Models
{
    public class JobApplication
    {
        ...
        [DOBValidation(ErrorMessage = "Age must be between 21 - 25")]
        ...
        [Required]
        [PasswordValidate(ErrorMessage = "Password must start with an uppercase letter, followed by a digit, and then 5 characters.")]
