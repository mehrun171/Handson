<%@ Page Title="Add Bill" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="AddBill.aspx.cs" Inherits="ElectricityBillingSystem.AddBill" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <br />
    <br />
    <asp:Label ID="lblBillCountPrompt" runat="server" Text="How many bills do you want to enter?" />
    <asp:TextBox ID="txtBillCount" runat="server" />
    <asp:Button ID="btnStartEntry" runat="server" Text="Start Entry" OnClick="btnStartEntry_Click" />
    <br /><br />

    <asp:HiddenField ID="hfCurrentCount" runat="server" />

    <asp:Panel ID="pnlBillEntry" runat="server" Visible="false">
        ...
        <p>
            <asp:Button ID="btnSubmit" runat="server" Text="Submit Bill" Enabled="false" ValidationGroup="BillGroup" OnClick="btnSubmit_Click" />
        </p>
